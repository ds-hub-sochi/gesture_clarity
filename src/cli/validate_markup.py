...
def validate_markup(  # pylint: disable=[too-many-locals]
    ...
    embeddings_dump_path: pathlib.Path = (
        repository_dir_path / './data/additional/embeddings/navec_hudlit_v1_12B_500K_300d_100q.tar'
    )
    ...
    for label in accuracy_over_label:
